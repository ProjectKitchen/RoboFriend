...
def sendToIOWarrior(earColorR, earColorG, earColorB, cameraPos = None):
    cmd = 'sudo /home/pi/robofriend_SW/RoboFriend/src/Pi/catkin_ws/src/robofriend_wrapper/src/iowarrior/iow ' + str(int(round(earColorR))) + ' ' + str(int(round(earColorG))) + ' ' + str(int(round(earColorB)))
    if cameraPos:
